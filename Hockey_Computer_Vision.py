...
def redraw():
    #Title Font
    # pygame.font.Font('grawust.regular.ttf', 50)
    # font = pygame.font.SysFont('grawust',30)
...
while run:
    ...
    if pong.rect.x > 1280:
        ...
        # winsound.PlaySound('gol.wav', winsound.SND_PURGE)
        pong.speed +=5
        pong.dx = -1
        paddle1.points +=1
    ...
    win.blit(frame, (0, 0))
    # win.blit(background1, rect_background1)
